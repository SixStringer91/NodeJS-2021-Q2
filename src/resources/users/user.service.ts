...
export const createUser = (user: User):Promise<Omit<User, 'password'>> => usersRepo.createNewUser(user);
export const updateUser = (obj:
{
  id:string,
  name?:string,
  password?:string,
  login?:string }):Promise<Omit<User, 'password'> | null> => usersRepo.updateUser(obj);
